	...
	axios
		...
		.then(function(response) {
            ...
            console.log(response)
				...
				response.data.data.map((item, indx) => {

                    if(arr.includes(item.formId)){
                      $(`.pan_${item.formId}`).text(Number($(`.pan_${item.formId}`).text()) + 1)
                    }else{
                        ...
                        <div class="card ${color[Math.floor(Math.random() * color.length)]}  text-white ">
                            <a href="view-submissions.html?${item.formId}">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <h2 class="text-white mb-0">${item.title}</h2>
                                            <span class="text-white mb-0">Total Registrations: <span class="pan_${item.formId}">1</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
